      ...
      return showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            content: const Text('Apakah kamu ingin menelpon pemilik kos?'),
            actions: <Widget>[
              TextButton(
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            FacilityItem(
                              name: 'Kitchen',
                              imageUrl: 'assets/iconkitchen.png',
                              total: widget.space.numberOfKitchens,
                            ),
                            FacilityItem(
                              name: 'Bedroom',
                              imageUrl: 'assets/iconbedroom.png',
                              total: widget.space.numberOfBedrooms,
                            ),
                            FacilityItem(
                              name: 'Big Lemari',
                              imageUrl: 'assets/iconcupboard.png',
